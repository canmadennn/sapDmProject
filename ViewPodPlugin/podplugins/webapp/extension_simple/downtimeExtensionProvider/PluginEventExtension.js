sap.ui.define([
    ...
    return PluginControllerExtension.extend("com.maden.viewplugins.extension.downtimeExtensionProvider.PluginEventExtension", {
        ...
        onGetReasonCodeDialogFragment: function(sId, sFragment, oContext) {
            ...
            return Fragment.load({
                id: sId,
                name: "com.maden.viewplugins.extension.downtimeExtensionProvider.fragment.CustomReasonCodeDialog",
                controller: this
            });
        },
