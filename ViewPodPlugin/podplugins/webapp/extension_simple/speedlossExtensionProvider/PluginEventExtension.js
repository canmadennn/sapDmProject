sap.ui.define([
    ...
    return PluginControllerExtension.extend("com.maden.viewplugins.extension.speedlossExtensionProvider.PluginEventExtension", {
        ...
        onGetReasonCodeDialogFragment: function(sId, sFragment, oContext) {
            ...
            return Fragment.load({
                id: sId,
                name: "com.maden.viewplugins.extension.speedlossExtensionProvider.fragment.CustomReasonCodeDialog",
                controller: this
            });
        },
