sap.ui.define([
    ...
    return PluginControllerExtension.extend("com.maden.viewplugins.extension.lineMonitorOrderSummaryExtensionProvider.LifecycleExtension", {
        ...
        onAfterRendering: function(oEvent) {
            if (!this.bFirstRenderComplete) {
                ...
                if (this.extensionMode === "MODIFY") {
                    ...
                    this.getCoreExtension().setCardView("com.maden.viewplugins.extension.lineMonitorOrderSummaryExtensionProvider.control.Extension");
                }
