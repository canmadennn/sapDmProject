sap.ui.define([
    ...
    return PluginControllerExtension.extend("com.maden.viewplugins.extension.operationPodSelectionExtensionProvider.LifecycleExtension", {
        ...
        onBeforeRendering: function(oEvent){
            if (!this._bInitialized) {
                ...
                let oData = this._oExtensionUtility.getJsonData("com/maden/viewplugins/extension/model/SuppliersModel.json");
