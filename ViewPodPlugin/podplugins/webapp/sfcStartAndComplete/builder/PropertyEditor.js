sap.ui.define([
    ...
    var oPropertyEditor = PropertyEditor.extend("com.maden.viewplugins.sfcStartAndComplete.builder.PropertyEditor", {
        constructor : function(sId, mSettings) {
            PropertyEditor.apply(this, arguments);
            this.setI18nKeyPrefix("exampleExecutionPlugin.");
            this.setResourceBundleName("com.maden.viewplugins.sfcStartAndComplete.i18n.builder");
            this.setPluginResourceBundleName("com.maden.viewplugins.sfcStartAndComplete.i18n.i18n");
        },
